...
<form:form modelAttribute="review" action="write" enctype="multipart/form-data" name="f">
	<h3 id="review-title">${item.itemname}</h3>
	<table>
		<tr><td colspan="4"><hr></td></tr>
		<tr>
			<th>아이디</th><td><form:input path="userid" value="${user.userid}" readonly="true"/></td>
			<th>상품번호</th><td><form:input path="itemid" value="${item.itemid}" readonly="true"/></td>
		</tr>
		<tr>
	...
	<div id="dv2">
		<a href="javascript:document.f.submit()">리뷰 등록</a>
